...
if($_SERVER['REQUEST_METHOD'] = "POST") {
    ...
    mysql_query("INSERT INTO `model` (`name`, `description`, `upload_date`, `author`, `year`, `museum`, `filename`, `verified`) VALUES ('$name','$description', '$upload_date','$author','$year','$museum', '$filename', 1)"); 
